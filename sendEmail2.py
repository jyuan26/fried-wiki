...
receiver_email = 'friedepicman@gmail.com'
spoofed_email = 'jyuan26@crystal.org'
spoofed_name = 'Jason Yuan'
message = 'Hello Jason, I am a ghost!!!'
subject = 'A message from a dead ghost'
